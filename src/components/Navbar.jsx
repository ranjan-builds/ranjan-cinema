          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="relative p-3 rounded-xl bg-gray-800/50 hover:bg-gray-700/50 border border-gray-600/50 hover:border-yellow-400/30 transition-all duration-300 group"
                title="Saved Movies"
              >
                <Bookmark className={`
              ...
              <button
                ...
                className="lg:hidden p-2 rounded-lg bg-gray-800/50 hover:bg-gray-700/50 border border-gray-600/50 transition-all duration-300"
              >
                {isMobileMenuOpen ? (
